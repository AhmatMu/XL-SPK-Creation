...
trigger Trigger_Opportunity_Profitabilty_v2 on Opportunity (after update) {

    if (system.label.is_Trigger_Opportunity_Profitabilty_v2_On == 'YES') {
            ...
            if (trigger.isAfter) {
                ...
                for (Opportunity Opp: system.trigger.new) {
                    ...
                    if (
                        ...
                        (Opp.RecordtypeName__c == 'Simcard Postpaid/Prepaid' || Opp.RecordtypeName__c == 'Simcard Device Bundling' || Opp.RecordtypeName__c == 'Project Bulkshare')
                    ) {
