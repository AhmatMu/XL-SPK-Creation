...
trigger Trigger_OrderItem on OrderItem (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
	if (label.Is_Trigger_ORDERITEM_ON == 'YES') {
		if(trigger.isInsert){
